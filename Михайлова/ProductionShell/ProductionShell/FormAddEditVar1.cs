...
namespace ProductionShell
{
	public class FormAddEditVar1 : Form
	{
		...
		private void InitializeComponent()
		{
			...
			base.SuspendLayout();
			this.buttonCancel.Location = new Point(193, 508);
			...
			this.buttonOK.Location = new Point(112, 508);
			...
			this.textBoxName.Location = new Point(11, 24);
			...
			this.groupBox1.Size = new Size(262, 250);
			this.groupBox1.TabIndex = 25;
			this.groupBox1.TabStop = false;
			this.groupBox1.Text = "Домен";
			this.button1.Location = new Point(3, 181);
			this.button1.Name = "button1";
			this.button1.Size = new Size(256, 23);
			this.button1.TabIndex = 30;
			this.button1.Text = "Добавить домен";
			...
			this.comboBoxDomain.Location = new Point(4, 15);
			...
			this.buttonEditDomain.Location = new Point(2, 204);
			...
			this.buttonClearDomai.Location = new Point(1, 227);
			...
			this.buttonClearDomai.Click += new EventHandler(this.buttonClearDomain_Click);
			...
			this.listViewValues.Location = new Point(2, 39);
			this.listViewValues.MultiSelect = false;
			this.listViewValues.Name = "listViewValues";
			this.listViewValues.Size = new Size(256, 133);
			...
			this.groupBoxQuestion.Location = new Point(10, 347);
			...
			this.groupBoxQuestion.Enter += new EventHandler(this.groupBoxQuestion_Enter);
			...
			this.groupBox3.Location = new Point(10, 436);
			...
			base.ClientSize = new Size(284, 536);
		...
		private void radioButtonAsked_Click(object sender, EventArgs e)
		{
			...
			this.groupBoxQuestion.Enabled = true;
			RichTextBox expr_21 = this.richTextBoxQuestion;
			expr_21.Text = expr_21.Text + this.textBoxName.Text + " =?";
		...
		{
			if ((this.radioButtonAsked.Checked || this.radioButtonDeducibleAsked.Checked) && this.richTextBoxQuestion.Text == "")
			{
				RichTextBox expr_41 = this.richTextBoxQuestion;
				expr_41.Text = expr_41.Text + this.textBoxName.Text + " =?";
			}
