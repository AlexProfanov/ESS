...
namespace ProductionShell
{
	public class FormVarList1 : Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.listViewVar.Size = new Size(530, 353);
			...
			this.buttonClose.Location = new Point(544, 333);
			...
			this.groupBox2.Location = new Point(544, 123);
			...
			this.groupBox1.Location = new Point(541, 3);
			this.groupBox1.Name = "groupBox1";
			this.groupBox1.Size = new Size(213, 108);
			this.groupBox1.TabIndex = 5;
			this.groupBox1.TabStop = false;
			this.buttonRemoveVar.AutoSize = true;
			this.buttonRemoveVar.Location = new Point(3, 66);
			...
			this.buttonEditVar.Location = new Point(3, 44);
			...
			base.ClientSize = new Size(758, 358);
